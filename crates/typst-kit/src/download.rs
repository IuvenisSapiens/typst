...
impl Downloader {
    ...
    pub fn with_cert(user_agent: impl Into<EcoString>, cert: Certificate<'static>) -> Self {
        Self {
            user_agent: user_agent.into(),
            cert_path: None,
    ...
    pub fn download(&self, url: &str) -> Result<ureq::http::Response<ureq::Body>, ureq::Error> {
...
impl<'p> RemoteReader<'p> {
    ...
    fn from_response(response: ureq::http::Response<ureq::Body>, progress: &'p mut dyn Progress) -> Self {
